...
class RolesController extends Controller
{
  ...
  public function refresh()
  {
      ...
      ->addColumn('action', function($roles){
          return '<button class="btn btn-xs btn-warning update_role" id="'.$roles->id.'"><i class="material-icons">mode_edit</i></button>&nbsp
          <button class="btn btn-xs btn-danger delete_role" id="'.$roles->id.'"><i class="material-icons">delete</i></button>';
      })
      ->make(true);
  }
