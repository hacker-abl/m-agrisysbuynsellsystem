...
class trucksController extends Controller
{
    ...
    public function refresh()
    {
        ...
        ->addColumn('action', function($trucks){
            return '<div class="btn-group"><button class="btn btn-xs btn-warning update_trucks waves-effect" id="'.$trucks->id.'"><i class="material-icons">mode_edit</i></button>
            <button class="btn btn-xs btn-danger delete_trucks waves-effect" id="'.$trucks->id.'"><i class="material-icons">delete</i></button></div>';
        })
        ->make(true);
    }
